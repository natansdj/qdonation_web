...
export default function Produk() {
  ...
  const dataListCategory = useAppSelector(
    (state) => state.program.dataListCategory
  );
  const loadingListCategory = useAppSelector(
    (state) => state.program.loadingListCategory
  );
  ...
  useEffect(() => {
    if (
      !loadingList &&
      dataList.page &&
      dataList.page < dataList.total_page &&
      more
    ) {
      setMore(false);
      dispatch(
